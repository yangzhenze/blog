            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="${articleCustom.articleImg}" id="demo1" width="200"
                             height="200">
                        <p id="demoText"></p>
                    </div>
                    <button type="button" class="layui-btn" id="test1">上传图片</button>
                    <input type="hidden" name="articleImg" id="articleImg" value="${articleCustom.articleImg}">
                </div>
            </div>
        </div>
