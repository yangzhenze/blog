...
<rapid:override name="content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/article/insertSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" src="/img/thumbnail/random/img_2.jpg" id="demo1"  width="200"
                             height="200">
                        <p id="demoText"></p>
                    </div>
            ...
            <input type="hidden" value="/img/thumbnail/random/img_2.jpg" name="articleImg" id="articleImg" value="">
        </div>
